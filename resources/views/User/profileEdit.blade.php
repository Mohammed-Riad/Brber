                        ...
                        <div class="col-12 col-md-12 col-lg-8 col-xl-6">
                            <div class="card" style="border-radius: 15px;">
                                <div class="card-body p-5">
                                    <h1 class="text-uppercase text-center mb-5"> Edit Profile Infomation</h1>
                                    ...
                                    <form action="/update" method="post" role="form" enctype="multipart/form-data">
                                        ...
                                        <div class="form-outline mb-5">
                                            <input type="text" id="input" class="form-control form-control-lg"
                                                required value="{{ $userData->name }}" name="name" />
                                        ...
                                        <div class="form-outline mb-5">
                                            <input type="text" id="input" class="form-control form-control-lg"
                                                name="address" required value="{{ $userData->address }}" />
                                        ...
                                        <div class="form-outline mb-5">
                                            <input type="text" id="input" class="form-control form-control-lg"
                                                name="phone" required value="{{ $userData->phone }}" />
